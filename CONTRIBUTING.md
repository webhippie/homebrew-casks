...
If unique, [open an issue](https://github.com/webhippie/homebrew-casks/issues) and answer the questions so we can understand and reproduce the problematic behavior.
